...
function load_donor($sql,$con)
{
	echo '
				...
				<th>Delete</th>
							...
							{
								echo "<div >No Such Donor Is Available</div>";
							}
				...
				<th>Update</th>
							...
							if($result->num_rows>0)
							{
								...
								{   
									...
									echo "<td><a href='#' class='btn btn-warning btn-xs'><i class='fa fa-bed'></i> Pending</a></td>";
									...
									echo "<td><a href='#' class='btn btn-danger btn-xs'><i class='fa fa-bed'></i> Rejected</a></td>";
